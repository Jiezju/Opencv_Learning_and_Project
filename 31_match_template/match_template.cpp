//
// Created by Bright on 2022/5/16.
//
...
int main() {
    ...
    //【1】载入原图像和模板块
    g_srcImage = imread("1.jpeg", 1);
    g_templateImage = imread("2.jpeg", 1);
...
void on_Matching(int, void *) {
    ...
    rectangle(srcImage, matchLocation,
              Point(matchLocation.x + g_templateImage.cols, matchLocation.y + g_templateImage.rows), Scalar(0, 0, 255),
              2, 8, 0);
